...
| DOC-014 | Render related images and OCR in answers | Images can now render, but they appear below the answer and OCR handling is not controlled cleanly. | Add Ask-tab toggles for related images, inline OCR, and OCR expanders. Render images inline where embedded image markers appear when possible; otherwise show related images below the answer. | High | Done |
...
# Retrieval Debug Review Tracking
