...
SMOKE_TESTS = [
    # --- Single structured record lookup ---
    {
        ...
        "must_not_contain": [],
        "expected_methods": ["structured_identifier_lookup", "semantic", "answer"],
        "min_results": 1,
        "enum_count_max": None,
    },
    {
    ...
    # --- Discovery list by broker ---
    {
        ...
        "description": "Discovery list — Goldman recon files",
        "must_contain": ["match"],
    ...
    },
    {
        ...
        "description": "Discovery list — all Goldman recon files",
        "must_contain": ["match"],
        "must_not_contain": ["0 match"],
        "expected_methods": ["discovery_list"],
        "min_results": 2,
