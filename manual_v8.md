...
Methodology & Operations Manual*
  ...
  Field                    Value
  ------------------------ ---------------------------------------------------------------------------------------------------------------------------------------
  **Version**              Phase 4++ / Deterministic Routing, Answer Arbitration & Cross-Link Delivery --- July 2026 (v8)
  ...
  **Active Collections**   xml\_test, bbg\_fields, kb\_docs, recon\_assist\_file, obsidian, pdf\_test, docx\_test, image\_test, astro\_test, astro\_catalog, M51
