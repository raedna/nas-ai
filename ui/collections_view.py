...
def render_collections_panel():
    ...
    name_in = ui.input("Collection name").props("outlined dense").classes("w-full")
    path_in = ui.input("Path (file or folder)").props("outlined dense").classes("w-full")
    ft_in = ui.select(ftypes, multiple=True, label="Allowed filetypes").props("outlined dense").classes("w-full")
    allow_ext = ui.input("Allowed extensions (comma-separated, include dots)").props("outlined dense").classes("w-full")
    excl_dirs = ui.input("Exclude folders (comma-separated)").props("outlined dense").classes("w-full")
    excl_ext = ui.input("Exclude extensions (comma-separated, include dots)").props("outlined dense").classes("w-full")
    asset_roots = ui.textarea("Asset search roots (one path per line)").props("outlined dense").classes("w-full")
    ...
    desc_in = ui.textarea("Routing description (required)").props("outlined dense").classes("w-full")
